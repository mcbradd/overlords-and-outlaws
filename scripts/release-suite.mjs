...
const checks = [
  ...
  ["core-stable-table", script("core-stable-table.ts")],
  ...
  ["core-challenge-return-regression", script("core-challenge-return-regression.ts")],
  ...
  ["core-tutorial-overlay", script("core-tutorial-overlay.ts")],
  ["core-ai-ready", script("core-ai-ready.ts")],
  ["core-victory", script("core-victory.ts")],
